...
Contributors/Copyright:
    2011-2016, 2018, 2022-2023 Bernhard F.W. Gschaider <bgschaid@hfd-research.com>
...
#ifdef FOAM_MESH_ZONE_ZONE_MESH_METHOD_IS_MESH_ZONES
#define ZoneMesh MeshZones
#endif
