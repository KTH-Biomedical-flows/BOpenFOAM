...
runIt $switch_on_FPE groovyBC/nonBreakingDam
...
runIt $switch_off_FPE Python3Integration/flowStatePitzDaily
runIt $switch_off_FPE Python3Integration/python3ScriptedBCAngledDuct
runIt $switch_on_FPE RegionSolvers/cavityAndPlate
runIt $switch_on_FPE RegionSolvers/cavityWithHeater
runIt $switch_on_FPE RegionSolvers/HronTurekFsi  --run-until=0.4
...
runIt $switch_on_FPE tests/conditionalWriting/signalHandlerPitzDaily
