...
Contributors/Copyright:
    2010-2014, 2016, 2018, 2021 Bernhard F.W. Gschaider <bgschaid@hfd-research.com>
...
{
    //    Dbug << "Constructor 1 facesSet " << getHex(&set) << " - "
    //        << getHex(faceSet_.get()) << endl;
}
...
{
    //       Dbug << "Constructor 2 facesSet " << getHex(&set) << " - "
    //        << getHex(faceSet_.get()) << endl;
}
...
{
    //    Dbug << "Constructor 3 " << getHex(faceSet_.get()) << endl;
    //    assert(faceSet_.get() != nullptr);
}
...
{
    //    Dbug << "Constructor 4 " << getHex(faceSet_.get()) << endl;
}
...
{
    Dbug << "FaceSet: update " << faceSet_->name() << endl;
