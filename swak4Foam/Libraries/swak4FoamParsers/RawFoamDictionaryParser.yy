...
Contributors/Copyright:
    2017-2022 Bernhard F.W. Gschaider <bgschaid@hfd-research.com>
...
%initial-action
{
    ...
    const std::string *fn = (&(driver.is().name()));
    @$.begin.filename = @$.end.filename = const_cast<std::string*>(fn);
};
