...
Contributors/Copyright:
    2010-2023 Bernhard F.W. Gschaider <bgschaid@hfd-research.com>
...
label CommonValueExpressionDriver::readForeignMeshInfo(
    ...
    forAll(names,i) {
        ...
        const word interpolationOrder(info.lookup("interpolationOrder"));
#else
...
)
{
  return tmp<scalarField>(
      new scalarField(
          this->size(),
#ifdef FOAM_INTERPOLATION_TABLE_CALL_BY_VALUE_METHOD
          lines_[name].value(t)
#else
          lines_[name](t)
#endif
