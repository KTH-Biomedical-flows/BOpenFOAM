...
Contributors/Copyright:
    2011, 2013-2014, 2016-2022 Bernhard F.W. Gschaider <bgschaid@hfd-research.com>
    ...
    )
{
    ...
    {
        if(evaluateDuringConstruction_) {
            WarningInFunction
                << "Evaluating jump expression for " << dict.name()
                    << " during construction. If this fails set" << nl
                    << "  evaluateDuringConstruction false;" << nl
