...
Contributors/Copyright:
    2012-2018, 2020-2023 Bernhard F.W. Gschaider <bgschaid@hfd-research.com>
...
typedef LESModel<incompressible::momentumTransportModel> LES_MODEL;
typedef RASModel<incompressible::momentumTransportModel> RAS_MODEL;
#else
typedef incompressible::LESModel LES_MODEL;
typedef incompressible::RASModel RAS_MODEL;
#endif
    ...
    if(!turb_.found(reg.name())) {
        ...
        turb_.set(
            ...
            incompressibleTurbulenceModel::New(
                ...
                const_cast<swakKinematicTransportModel &>(transportInternal(reg))
            ).ptr()
        );
    }
