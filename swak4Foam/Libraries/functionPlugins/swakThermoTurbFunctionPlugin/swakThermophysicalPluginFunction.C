...
Contributors/Copyright:
    2012-2013, 2015-2018, 2020-2023 Bernhard F.W. Gschaider <bgschaid@hfd-research.com>
...
#ifdef FOAM_THERMO_ALPHA_IS_NOW_ALPHAHE
concreteThermoFunction(alphahe, volScalarField, basicThermo);
#else
...
#ifndef FOAM_BASICTHERMO_HAS_NO_CPBYCPV_METHOD
