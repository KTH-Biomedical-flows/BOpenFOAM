...
Contributors/Copyright:
    2008-2013, 2015-2018, 2020-2021 Bernhard F.W. Gschaider <bgschaid@hfd-research.com>
...
:
    ...
    noWrite_(
        dict.lookupOrDefault<bool>("noWrite",false)
    ),
    noExecute_(
        dict.lookupOrDefault<bool>("noExecute",false)
    ),
#endif
    dict_(
        dict.parent(),
...
bool simpleFunctionObject::execute() {
    ...
    if(!noExecute_ && ensureExecuteOnce()) {
