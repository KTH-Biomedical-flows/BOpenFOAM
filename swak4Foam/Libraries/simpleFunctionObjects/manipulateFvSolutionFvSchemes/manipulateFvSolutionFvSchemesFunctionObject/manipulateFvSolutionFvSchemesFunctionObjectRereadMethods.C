...
Contributors/Copyright:
    2015-2018, 2021 Bernhard F.W. Gschaider <bgschaid@hfd-research.com>
...
struct ReadFvSchemes {
#ifdef FOAM_FVSCHEMES_READ_RETURNS_SCHEME_LOOKUP
    typedef void(schemesLookup::*type)(const dictionary &);
#else
    typedef void(fvSchemes::*type)(const dictionary &);
#endif
};
